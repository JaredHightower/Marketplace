...
NFT Marketplace with the Moralis SDK. This project work on any EVM-compatible blockchain such as Polygon, Avalanche, Binance Smart Chain and other such chains.
```
